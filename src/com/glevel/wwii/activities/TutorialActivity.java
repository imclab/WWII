...
public class TutorialActivity extends GameActivity {
    ...
    private static final int[] TUTORIAL_INSTRUCTIONS = { R.string.tutorial0, R.string.tutorial1, R.string.tutorial2,
            R.string.tutorial3, R.string.tutorial4, R.string.tutorial5, R.string.tutorial6, R.string.tutorial7,
            R.string.tutorial8, R.string.tutorial9, R.string.tutorial10, R.string.tutorial11 };
    ...
    protected void initGameActivity() {
        ...
        // init human player
        Player mPlayer = new Player("Me", ArmiesData.USA, 0, false, battle.getPlayerVictoryCondition(ArmiesData.USA));
        mPlayer.getUnits().add(UnitsData.buildRifleMan(mPlayer.getArmy(), Experience.ELITE));
        mPlayer.getUnits().add(UnitsData.buildRifleMan(mPlayer.getArmy(), Experience.ELITE));
        mPlayer.getUnits().add(UnitsData.buildScout(mPlayer.getArmy(), Experience.ELITE));
        mPlayer.getUnits().add(UnitsData.buildHMG(mPlayer.getArmy(), Experience.VETERAN));
        mPlayer.getUnits().add(UnitsData.buildATCannon(mPlayer.getArmy(), Experience.VETERAN));
        mPlayer.getUnits().add(UnitsData.buildShermanM4A1(mPlayer.getArmy(), Experience.ELITE));
        battle.getPlayers().add(mPlayer);

        // create AI's player
        Player enemyPlayer = new Player("Enemy", ArmiesData.GERMANY, battle.getPlayers().size(), false,
                battle.getPlayerVictoryCondition(ArmiesData.GERMANY));
        enemyPlayer.getUnits().add(UnitsData.buildRifleMan(enemyPlayer.getArmy(), Experience.RECRUIT));
        enemyPlayer.getUnits().add(UnitsData.buildRifleMan(enemyPlayer.getArmy(), Experience.RECRUIT));
