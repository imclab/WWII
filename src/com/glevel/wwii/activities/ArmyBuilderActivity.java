...
public class ArmyBuilderActivity extends MyActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// create AI's player
		Player enemyPlayer = new Player("Enemy", mPlayerArmy.getEnemy(), mBattle.getPlayers().size(), true, mBattle.getPlayerVictoryCondition(mPlayerArmy
				.getEnemy()));
	...
	private void setupUI() {
		...
		UnitsArrayAdapter mAvailableTroopsAdapter = new UnitsArrayAdapter(this, R.layout.army_list_item, mAvailableUnits, false);
