...
import com.glevel.wwii.activities.HomeActivity;
    ...
    public void openGameMenu() {
                ...
                Dialog confirmDialog = new CustomAlertDialog(mGameActivity, R.style.Dialog, mGameActivity
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == R.id.okButton) {
                            mGameActivity.endGame(mGameActivity.battle.getEnemyPlayer(mGameActivity.battle.getMe()),
                                    true);
                            GoogleAnalyticsHelper.sendEvent(mGameActivity, EventCategory.ui_action,
        ...
        mGameMenuDialog.findViewById(R.id.exitButton).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GoogleAnalyticsHelper.sendEvent(mGameActivity, EventCategory.ui_action, EventAction.button_press,
                        "exit_game");
            }
        });
    ...
    public void updateSelectedElementLayout(final GameSprite selectedElement) {
        mGameActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                // health
                ((TextView) mSelectedUnitLayout.findViewById(R.id.unitName)).setTextColor(mGameActivity.getResources()
