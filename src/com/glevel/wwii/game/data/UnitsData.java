...
public class UnitsData {
	...
	public static Unit buildRifleMan(ArmiesData army, Experience experience) {
		...
		case GERMANY:
			...
			return new Soldier(army, R.string.rifleman, R.drawable.ic_launcher,
	...
	public static Unit buildHMG(ArmiesData army, Experience experience) {
		...
		case GERMANY:
			...
			return new Soldier(army, R.string.hmg, R.drawable.ic_launcher,
					experience, weapons, 1);
		case USA:
	...
	public static Unit buildBazooka(ArmiesData army, Experience experience) {
		...
		case GERMANY:
			...
			return new Soldier(army, R.string.panzerschreck,
					R.drawable.ic_launcher, experience, weapons, 1);
		case USA:
			weapons.add(WeaponsData.buildBazooka());
			return new Soldier(army, R.string.bazooka, R.drawable.ic_launcher,
					experience, weapons, 1);
		}
		return null;
	}
	...
	public static Unit buildMortar(ArmiesData army, Experience experience) {
		...
		case GERMANY:
			...
			return new Soldier(army, R.string.mortar, R.drawable.ic_launcher,
					experience, weapons, 1);
		case USA:
			weapons.add(WeaponsData.buildMortar50());
			return new Soldier(army, R.string.mortar, R.drawable.ic_launcher,
					experience, weapons, 2);
		}
		return null;
	}
	...
	public static Unit buildATCannon(ArmiesData army, Experience experience) {
		...
		case GERMANY:
			...
			return new Soldier(army, R.string.at_cannon,
					R.drawable.ic_launcher, experience, weapons, 0);
		case USA:
